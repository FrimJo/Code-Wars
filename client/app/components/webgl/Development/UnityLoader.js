...
var Module = {
    ...
    dataUrl: "Development/WebGL.data",
    codeUrl: "Development/WebGL.js",
    memUrl: "Development/WebGL.mem",
...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'scene1.data';
    var REMOTE_PACKAGE_BASE = 'scene1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2427920;
      var PACKAGE_UUID = '0c28f55e-e618-4568-b344-f703df4285be';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 107869, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(107869, 107888, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(107888, 107907, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(107907, 1525323, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1525323, 2400295, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2400295, 2427920, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_scene1.data');

    };
    Module['addRunDependency']('datafile_scene1.data');
